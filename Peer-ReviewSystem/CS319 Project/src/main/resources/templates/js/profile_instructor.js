function myFunction() {
    ...
    document.getElementById("Course").innerHTML = getCourseName();
    document.getElementById("Semester").innerHTML = getSemesterName();
}
function getCourseName() {
    ...
    httpRq.onload = function () {
        ...
        document.getElementById("Course").innerHTML = " Course : "+ result;
    }
    httpRq.send();
}
...
function getSemesterName() {
    ...
    httpRq.onload = function () {
        let result = httpRq.responseText;
        document.getElementById("Semester").innerHTML = " Semester : " + result;
    }
    httpRq.send();
}
